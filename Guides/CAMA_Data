...
Nightly, a scripts called AA407 is run TylerTech and is output in Y:\AT_LWATSON\AA407 (as of 6/18/2021). This data needs to be zipped in the morning so that a script can 
